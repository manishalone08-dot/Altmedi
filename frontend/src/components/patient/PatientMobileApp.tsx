      ...
      <div className="bg-gradient-to-r from-teal-700 to-teal-800 text-white p-4 pt-5 pb-5">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="font-bold text-sm tracking-tight">{t('app.name')} {t('nav.rolePatient')}</h1>
              <span className="text-[10px] text-teal-200 font-medium">{t('app.tenant')}</span>
            </div>
          </div>
        ...
        {!selectedMedicine && !showCamera && !extractedItems && (
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-3.5 border border-white/20 text-xs">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-bold text-white text-sm">{t('camera.title')}</p>
              ...
              >
                ...
                <span className="text-[9px] font-bold mt-0.5">{t('camera.capture')}</span>
              </button>
            </div>
          </div>
        )}
